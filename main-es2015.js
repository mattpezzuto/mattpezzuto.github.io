...
let BattleScreenComponent = class BattleScreenComponent {
    ...
    performAttack(creatureListAttack, creatureListDefender, attackPlayerName, defendPlayerName) {
        // defensive layer 1
...
let TavernAppComponent = class TavernAppComponent {
    constructor() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["timer"])(1000, 1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeWhile"])(() => this.counter > -1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(() => this.counter--)
        // map((x) => {
        //   if (this.count === 0) { 
